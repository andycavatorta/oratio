...
class Main(threading.Thread):
    def __init__(self, hostname):
        ...
        self.status = {
            "avl-voice-3":"pass", # because this passes if it can respond.  maybe better tests in future
            ...
            try:
                ...
                if topic == "voice_3":
                    ...
                    try:
                        ...
                        self.update_device_status("avl-voice-3-crystal-frequency-counter", "pass")
                    except Exception as e:
                        self.update_device_status("avl-voice-3-crystal-frequency-counter", "fail")
                    ...
                    try:
                        ...
                        self.update_device_status("avl-voice-3-harmonic-generators", "pass")
                    except Exception as e:
                        self.update_device_status("avl-voice-3-harmonic-generators", "fail")
                    ...
                    try:
                        ...
                        self.update_device_status("avl-voice-3-harmonic-volume", "pass")
                    except Exception as e:
                        self.update_device_status("avl-voice-3-harmonic-volume", "fail")
