        ...
        while True:
            try:
                ...
                if topic == "voice_1":
                    ...
                    crystal.set_freq(0, vol and (self.xtal_freq - (freq_root+0.15 + self.f_offset)))

                    # subvoice 2 frequency and volume
                    crystal.set_freq(1, vol_sub1 and (self.xtal_freq - (freq_sub1+0.15 + self.f_offset)))
                    crystal.set_volume(1, map_subvoice_volume(vol_sub1))

                    # subvoice 3 frequency and volume
                    crystal.set_freq(2, vol_sub2 and (self.xtal_freq - (freq_sub2+0.15 + self.f_offset)))
