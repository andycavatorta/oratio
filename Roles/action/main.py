...
class Main(threading.Thread):
    def __init__(self, hostname):
        ...
        self.network.thirtybirds.subscribe_to_topic("pedal_1")
        self.network.thirtybirds.subscribe_to_topic("pedal_2")
        self.network.thirtybirds.subscribe_to_topic("pedal_3")
        self.network.thirtybirds.subscribe_to_topic("pedal_4")
        self.network.thirtybirds.subscribe_to_topic("pedal_5")
        self.network.thirtybirds.subscribe_to_topic("pedal_6")
