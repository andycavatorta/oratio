...
class Dispatcher(threading.Thread):
    ...
    def calculate_base_pitch(self, voice_num, priority):
        ...
        if priority == "transport":
            ...
            print "calculate_base_pitch transport", self.transport_pos_raw, self.transport_pos_at_last_pitch_key_event, self.transport_pos_at_last_pitch_key_event - self.transport_pos_raw, (self.transport_pos_at_last_pitch_key_event - self.transport_pos_raw) / self.transport_encoder_pulses_per_pitch
